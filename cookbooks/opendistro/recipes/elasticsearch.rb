...
# Add extra roles and users to Khulnasoft Kibana plugin

remote_file "#{node['elastic']['plugins_path']}/opendistro_security/securityconfig/roles.yml" do
  source "https://raw.githubusercontent.com/khulnasoft/khulnasoft-documentation/#{node['khulnasoft']['minor_version']}/resources/open-distro/elasticsearch/roles/roles.yml"
end

remote_file "#{node['elastic']['plugins_path']}/opendistro_security/securityconfig/roles_mapping.yml" do
  source "https://raw.githubusercontent.com/khulnasoft/khulnasoft-documentation/#{node['khulnasoft']['minor_version']}/resources/open-distro/elasticsearch/roles/roles_mapping.yml"
end

remote_file "#{node['elastic']['plugins_path']}/opendistro_security/securityconfig/internal_users.yml" do
  source "https://raw.githubusercontent.com/khulnasoft/khulnasoft-documentation/#{node['khulnasoft']['minor_version']}/resources/open-distro/elasticsearch/roles/internal_users.yml"
end
